...
- Enrollment is what makes [heartbeats](/api/docs/reference/heartbeat/) and signed
  [degraded-mode buffers](/api/docs/reference/config/) attributable to a specific PEP.
