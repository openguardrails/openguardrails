  ...
  return (
    <main>
      ...
      <section className="container-x py-10">
        <div className="card p-8 border-blue-200">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <a href="/skill/SKILL.md" className="rounded-lg px-4 py-2 bg-accent text-white text-sm font-semibold hover:bg-blue-700 transition font-mono">
              /skill/SKILL.md
            </a>
            <a href="/llms.txt" className="rounded-lg px-4 py-2 border border-zinc-300 text-sm font-semibold hover:bg-zinc-50 transition font-mono">
              /llms.txt
            </a>
            <a href={`${GH}/openguardrails/tree/main/skills/openguardrails`} className="rounded-lg px-4 py-2 border border-zinc-300 text-sm font-semibold hover:bg-zinc-50 transition">
              Source →
            </a>
          </div>
        </div>
      ...
      <section className="container-x py-12">
        ...
        <p className="text-zinc-600 max-w-2xl mb-7">
      ...
      <section className="container-x py-12">
        <div className="card p-8 border-blue-200 max-w-3xl">
          ...
          <ul className="space-y-3 text-zinc-600 leading-relaxed text-[15px]">
            <li>
              <span className="text-zinc-900 font-semibold">A human approves before a policy goes live.</span>{" "}
            ...
            <li>
              <span className="text-zinc-900 font-semibold">Enforcement sits outside your reach.</span>{" "}
      ...
      <section className="container-x py-12">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <a href={`${GH}/openguardrails/tree/main/examples`} className="rounded-lg px-5 py-3 border border-zinc-300 font-semibold hover:bg-zinc-50 transition">
            Runnable example
          </a>
        </div>
      </section>
