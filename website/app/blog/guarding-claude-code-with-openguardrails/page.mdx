...
The OGR plugin —
[`openguardrails-instrumentation-claude-code`](https://github.com/openguardrails/openguardrails/tree/main/integrations/agent/claude-code)
...
[Claude Code integration doc](/docs/integrations/agent/claude-code/).
...
[repo](https://github.com/openguardrails/openguardrails/tree/main/integrations/agent/claude-code).*
