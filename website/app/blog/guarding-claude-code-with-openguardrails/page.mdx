...
The OGR plugin —
[`openguardrails-instrumentation-claude-code`](https://github.com/openguardrails/openguardrails/tree/main/integrations/claude-code)
...
[repo](https://github.com/openguardrails/openguardrails/tree/main/integrations/claude-code).*
