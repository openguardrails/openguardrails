...
and ships for [Claude Code](/api/docs/plugins/claude-code/). Routing through OGR
means Kilo shares **one policy model, one composition engine, and one
[benchmark](https://github.com/openguardrails/openguardrails/tree/main/benchmarks)** with every
...
[GuardEvent & Verdict](/api/docs/reference/objects/guard-event/).*
