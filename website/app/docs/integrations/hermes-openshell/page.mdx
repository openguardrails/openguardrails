...
Where the [personal scenario](/docs/integrations/agent/hermes-srt/) secures one laptop
...
[openguardrails-instrumentation-hermes](https://github.com/openguardrails/openguardrails/tree/main/integrations/agent/hermes)
(the OpenShell adapter is [`sandbox/openshell.py`](https://github.com/openguardrails/openguardrails/blob/main/integrations/agent/hermes/src/openguardrails_instrumentation_hermes/sandbox/openshell.py)).
