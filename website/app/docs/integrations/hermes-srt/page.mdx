...
(the srt adapter is [`sandbox/srt.py`](https://github.com/openguardrails/openguardrails/blob/main/integrations/hermes/src/openguardrails_instrumentation_hermes/sandbox/srt.py)).
