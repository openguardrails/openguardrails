...
This is the block that the [srt](/docs/integrations/agent/hermes-srt/) and
[OpenShell](/docs/integrations/agent/hermes-openshell/) adapters compile. You describe the
...
reader verb — see why in [the Hermes findings](/docs/integrations/agent/hermes-srt/)).
