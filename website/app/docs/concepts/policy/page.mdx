...
This is the block that the [srt](/docs/plugins/hermes-srt/) and
[OpenShell](/docs/plugins/hermes-openshell/) adapters compile. You describe the
...
reader verb — see why in [the Hermes findings](/docs/plugins/hermes-srt/)).
...
Next: **[Instrument your agent](/docs/instrument-your-agent/)** if you're not on
Hermes.
