...
[Verdicts](/docs/api/objects/verdict/) into the single decision it enforces.
...
runtime at all — is [degraded mode](/docs/api/config/), configured via
`GET /v1/config`.
...
Next: **[Policy](/docs/concepts/policy/)** — the file where composition,
