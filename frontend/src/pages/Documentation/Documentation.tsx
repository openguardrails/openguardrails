...
const Documentation: React.FC = () => {
  ...
  const [isEnterpriseMode, setIsEnterpriseMode] = useState<boolean>(true)
  ...
  useEffect(() => {
    ...
    try {
      ...
      setIsEnterpriseMode(config.isEnterpriseMode)
    } catch (e) {
  ...
  "score": 0.95
            ...
            <div id="gateway-usage" className="mt-8">
              ...
              <pre className="bg-secondary p-4 rounded-md overflow-auto text-xs border border-border mb-4">
                {isEnterpriseMode ? `from openai import OpenAI
