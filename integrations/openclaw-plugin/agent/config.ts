...
// =============================================================================
// API Key Management (legacy MoltGuard)
// =============================================================================
...
const DASHBOARD_CONFIG_DIR = path.join(os.homedir(), ".openclaw/dashboard");
...
export const DEFAULT_CONFIG: Required<OpenClawGuardConfig> = {
  ...
  // Dashboard config (replaces platformUrl/platformApiKey)
  dashboardUrl: process.env.OG_DASHBOARD_URL || "http://localhost:8901",
