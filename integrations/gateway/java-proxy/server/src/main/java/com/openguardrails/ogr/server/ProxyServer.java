 ...
 * </pre>
 *
 * <p>It is documentation that runs. The thing a production Java service embeds is
 * {@code ogr-proxy-core}; this module shows what calling it looks like end to end,
 * including the part every write-up hand-waves — enforcing on a STREAMED reply.
 *
