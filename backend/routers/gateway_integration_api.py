...
from database.connection import get_async_detection_db
from sqlalchemy.ext.asyncio import AsyncSession
from services.gateway_integration_service import get_async_gateway_integration_service
...
async def process_input(
    ...
    db: AsyncSession = Depends(get_async_detection_db),
):
    """
